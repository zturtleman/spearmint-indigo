						...
						const vec3_t v1, const vec3_t v2, const vec3_t v3, const vec2_t t1, const vec2_t t2, const vec2_t t3)
{
	...
	// c2c1_T = V2.texcoord.x \96 V1.texcoord.x
	// c2c1_B = V2.texcoord.y \96 V1.texcoord.y
	// c3c1_T = V3.texcoord.x \96 V1.texcoord.x
	// c3c1_B = V3.texcoord.y \96 V1.texcoord.y
...
void R_SetupProjectionZ(viewParms_t *dest)
{
	...
	if (dest->isPortal)
	{
		...
		// Lengyel, Eric. \93Modifying the Projection Matrix to Perform Oblique Near-plane Clipping\94.
